const FETCH_CATEGORYS_REQUEST = 'FETCH_CATEGORYS_REQUEST';
const FETCH_CATEGORYS_SUCCESS = 'FETCH_CATEGORYS_SUCCESS';
const FETCH_CATEGORYS_FAILURE = 'FETCH_CATEGORYS_FAILURE';
